...
function Banner(){
    return(
     <section className='dark:text-white dark:bg-[#202124] w-full flex flex-wrap justify-between lg:pt-10 min-h-screen p-6 lg:px-36'>
        <div className="  lg:pl-8 text-center lg:text-left w-full lg:w-6/12">
         <div className='lg:p-6 lg:pt-20'>
           ...
           <h5 className='pt-2 lg:pt-10 lg:text-lg 2xl:text-4xl 2xl:pt-20 text-[#343434] montserrat'>IMAGINE-DESIGN-TATTOO</h5>
