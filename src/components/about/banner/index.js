        ...
        <section className='dark:bg-[#202124] dark:text-white p-6 min-h-screen lg:px-36'>
            <div className=' dark:bg-[#202124] dark:text-white bg-white pt-10 pb-10 flex flex-wrap items-center '> 
               <div className=' w-full  lg:w-4/12 '>
                   ...
                   <p className='dark:text-[#B5B5B5] montserrat px-4 lg:px-0 lg:pl-9 pt-4 text-[#141010] text-center lg:text-left'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed d</p>
