    ...
    return(
        ...
        <div className='lg:pt-8 dark:bg-[#202124] dark:text-white bg-white flex flex-wrap  justify-evenly items-center '> 
             <div className='lg:pl-24 w-full lg:w-5/12 '>
                 ...
                 <p className='dark:text-[#B5B5B5] montserrat  pt-4 lg:pt-6 lg:text-2xl 2xl:text-3xl 2xl:pt-8 px-4 lg:px-0  text-[#141010] text-center lg:text-left'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed d</p>
                 <div className=' flex justify-center lg:justify-start  lg:pt-14 2xl:pt-36 py-6'>
                    <button className=' dark:bg-[#8AB4F8] dark:text-black button-shadow rounded-lg bg-[#1A73E8] text-[#FFFFFF] px-10 py-1 text-sm montserrat lg:px-14 lg:py-2 lg:rounded-xl 2xl:px-24 2xl:py-3 2xl:text-2xl 2xl:rounded-2xl'>Book Now</button>
                </div>             
             </div>
