                 ...
                 <div className='  flex justify-center  w-full lg:w-4/12'>
                     <div className='dark:bg-[#202124] bg-white  py-8 2xl:py-20 rounded-2xl px-8'>
                       <div className='pb-4 2xl:pb-6 '>
                           <input className='dark:bg-[#464646] rounded-lg bg-[#EEEEEE] py-1 px-2  2xl:py-4 2xl:px-14' placeholder='Name' type="text" id="name"/>
                       </div>
                       <div className='pb-4  2xl:pb-6 '>
                           <input  className='dark:bg-[#464646]  rounded-lg bg-[#EEEEEE] py-1 px-2 2xl:py-4 2xl:px-14'  placeholder='E-mail Address'   type="email" id="e-mail"/>
                       </div>
                       <div className='pb-4  2xl:pb-6 '>
                           <input  className='dark:bg-[#464646]  rounded-lg bg-[#EEEEEE]  py-1 px-2 2xl:py-4 2xl:px-14' placeholder='Contact Number' type="text" id="number"/>
                       </div>
                       <div className='pb-20  2xl:pb-6 '>
                           <input className='dark:bg-[#464646]  rounded-lg bg-[#EEEEEE] py-8 px-2 2xl:py-4 2xl:px-14 ' placeholder='Get a Fresh Art ready from our Skilled ArtistS' type="textbox" id="date"/>
                       </div>
