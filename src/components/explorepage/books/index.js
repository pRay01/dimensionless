...
function Books(){
    return(
        <section className='dark:bg-[#202124] dark:text-white p-6 lg:py-20 2xl:py-28 lg:px-40'>
        <div className=' flex flex-wrap lg:justify-evenly '>
             <div className='w-full p-4 lg:w-6/12'>
                  ...
                  <p className='dark:text-[#B5B5B5] pt-2  2xl:pt-4 2xl:text-3xl px-6 lg:px-0 text-center lg:text-left'>
