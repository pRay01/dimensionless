...
function Upcoming(){
    return(
        ...
        <div className=' text-center font-semibold text-2xl lg:text-3xl py-6'>
            <h5>
                Upcoming Workshops
            </h5>
        </div>
        <div className='  justify-evenly items-center flex flex-wrap '>
             <div className=' w-full p-4 lg:w-6/12'>
                  ...
                  <p className='pt-3 px-8 lg:px-0 text-center lg:text-left'>
        ...
        <div className='pt-10 flex flex-wrap items-center justify-evenly p'>
           ...
           <div className='order-1 w-full p-4 lg:w-6/12'>
                  ...
                  <p className='pt-3 px-8 lg:px-0 text-center lg:text-right'>
