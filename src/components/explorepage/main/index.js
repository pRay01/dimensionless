...
function Main(){
    return(
        <section className=" dark:bg-[#202124]  dark:text-white  min-h-screen lg:pl-60 lg:px-36  ">
          ...
          <div className='flex pt-14 lg:pt-0 flex-wrap justify-evenly items-center'>
              ...
              <div className=' w-full  lg:w-4/12'>
                  ...
                  <p className='dark:text-[#B5B5B5] pt-6 px-8 lg:px-0 text-center lg:text-left'>
