    ...
    return(
     <footer className='bg-[#4D93EF] p-6 lg:px-40'>
         ...
         <div className=' w-full lg:w-9/12'>
                    ...
                    <p className='w-2/4 text-[#E3E3E3] text-sm pt-2 pb-8'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam</p>
                    <div className="pb-4">
                    <input className='rounded py-2 px-8 montserrat' type="email" placeholder="Your Email Address" />
                    </div>
                    <div className=" ">
         ...
         <div className=' text-[#E3E3E3] py-6 text-sm flex justify-evenly lg:justify-between' >
                 <div>Site Map</div>
