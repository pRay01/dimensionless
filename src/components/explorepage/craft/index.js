...
function Craft(){
    return(
        <section className=' bg-[#EEEEEE] p-6 lg:px-36'>
              <div className='pt-10 bg-[#EEEEEE] justify-evenly flex flex-wrap '>
                   <div className=' w-full p-4 lg:w-4/12'>
                        <div className='montserrat  font-semibold text-center lg:text-left text-4xl  2xl:text-8xl'>
                            <h3>Art</h3>
                        </div>
              ...
              <div className='pt-14 2xl:pt-40 pb-10 bg-[#EEEEEE] flex flex-wrap justify-evenly'>
