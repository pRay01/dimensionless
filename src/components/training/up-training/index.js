...
function Upcoming(){
    return(
        <section className='dark:bg-[#202124] dark:text-white  p-6  2xl:py-40 lg:px-40'>
        ...
        <div className=' py-10 2xl:py-20 justify-evenly items-center flex flex-wrap '>
             <div className=' w-full p-4 lg:w-6/12'>
                  ...
                  <button className='dark:bg-[#8AB4F8] dark:text-black button-shadow rounded-lg bg-[#1A73E8] text-[#FFFFFF] px-10 py-1 text-sm montserrat 2xl:px-16 2xl:text-2xl 2xl:rounded-2xl 2xl:py-3 2xl:px-16 2xl:text-2xl 2xl:rounded-2xl 2xl:py-3'>Book Now</button>
                  </div>
             </div>
